...
[
  ...
  if test "x$TOOLCHAIN_TYPE" = xgcc; then
    ...
    TOOLCHAIN_CFLAGS_JVM="-nologo -MD -Zc:preprocessor -Zc:strictStrings -MP -utf-8"
    TOOLCHAIN_CFLAGS_JDK="-nologo -MD -Zc:preprocessor -Zc:strictStrings -Zc:wchar_t- -utf-8"
  fi
