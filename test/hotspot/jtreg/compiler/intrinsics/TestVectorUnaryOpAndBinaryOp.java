 ...
 *
 * @run driver compiler.intrinsics.TestVectorUnaryOpAndBinaryOp
 */

public class TestVectorUnaryOpAndBinaryOp {

    @Test
    @IR(counts = { IRNode.CALL_LEAF_VECTOR, "= 1" }, applyIfCPUFeatureOr = { "avx", "true" })
    public static void testUnary() {
        var vec = FloatVector.broadcast(FloatVector.SPECIES_256, 3.14f);
    ...
    public static void testBinary() {
        var vec = FloatVector.broadcast(FloatVector.SPECIES_256, 2.0f);
